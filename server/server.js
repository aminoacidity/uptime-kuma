    ...
    io.on("connection", async (socket) => {
        ...
        socket.on("editMonitor", async (monitor, callback) => {
            try {
                ...
                bean.imapUsername = monitor.imapUsername;
                bean.imapPassword = monitor.imapPassword;
                bean.imapProtocol = monitor.imapProtocol;
                bean.imapSearchQuery = monitor.imapSearchQuery;
                bean.imapSearchField = monitor.imapSearchField;
                bean.imapDeleteAfterCheck = monitor.imapDeleteAfterCheck;
                bean.imapMailbox = monitor.imapMailbox;
